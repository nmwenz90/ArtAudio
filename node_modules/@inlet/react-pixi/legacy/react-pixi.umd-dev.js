(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('pixi.js-legacy'), require('react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'pixi.js-legacy', 'react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactPixi = {}, global.PIXI, global.React));
}(this, (function (exports, pixi_jsLegacy, React) { 'use strict';
  ...
  function isPointType(value) {
    return value instanceof pixi_jsLegacy.Point || value instanceof pixi_jsLegacy.ObservablePoint;
  }
  /**
   * Event handlers
   *
  ...
  var getTextureFromProps = function getTextureFromProps(elementType) {
    ...
    if (props.texture) {
      invariant(props.texture instanceof pixi_jsLegacy.Texture, "".concat(elementType, " texture needs to be typeof `PIXI.Texture`"));
      ...
      var result = check('image', {
        ...
        instanceofs: [HTMLImageElement, HTMLVideoElement, HTMLCanvasElement, pixi_jsLegacy.Texture]
      });
      invariant(!!result, "".concat(elementType, " could not get texture from props"));
      var texture = pixi_jsLegacy.Texture.from(result);
  ...
  function applyDefaultProps(instance, oldProps, newProps) {
    var changed = false;
    invariant(pixi_jsLegacy.DisplayObject.prototype.isPrototypeOf(instance), 'instance needs to be typeof `PIXI.DisplayObject`, ' + 'got `%s`', _typeof(instance)); // update event handlers
  ...
  var BitmapText$1 = function BitmapText(root, props) {
    var text = props.text,
        style = props.style;
    return new pixi_jsLegacy.BitmapText(text, style);
  };
  ...
  var Graphics$1 = function Graphics(root, props) {
    var g = new pixi_jsLegacy.Graphics();
  ...
  var NineSlicePlane$1 = function NineSlicePlane(root, props) {
    ...
    var nineSlicePlane = new pixi_jsLegacy.NineSlicePlane(texture, leftWidth, topHeight, rightWidth, bottomHeight);
  ...
  var ParticleContainer$1 = function ParticleContainer(root, props) {
    ...
    var container = new pixi_jsLegacy.ParticleContainer(maxSize, properties, batchSize, autoResize);
  ...
  var Sprite$1 = function Sprite(root, props) {
    var sprite = new pixi_jsLegacy.Sprite(getTextureFromProps('Sprite', props));
  ...
  var AnimatedSprite$1 = function AnimatedSprite(root, props) {
    ...
    var makeTexture = function makeTexture(textures) {
      return textures.map(function (texture) {
        invariant(texture instanceof pixi_jsLegacy.Texture || (texture === null || texture === void 0 ? void 0 : texture.texture), "AnimationSprite texture needs to be an array of `PIXI.Texture` or `{ texture: PIXI.Texture, time: number }`");
        return texture;
      });
    };

    var animatedSprite = images ? pixi_jsLegacy.AnimatedSprite.fromImages(images) : new pixi_jsLegacy.AnimatedSprite(makeTexture(textures));
  ...
  var Text$1 = function Text(root, props) {
    ...
    var pixiText = new pixi_jsLegacy.Text(text, style);

    if (isSprite) {
      pixiText.updateText();
      return new pixi_jsLegacy.Sprite(pixiText.texture);
    }
  ...
  var TilingSprite$1 = function TilingSprite(root, props) {
    ...
    var ts = new pixi_jsLegacy.TilingSprite(texture, width, height);
  ...
  var SimpleMesh$1 = function SimpleMesh(root, props) {
    ...
    var vertices = props.vertices,
        ...
        drawMode = _props$drawMode === void 0 ? pixi_jsLegacy.DRAW_MODES.TRIANGLES : _props$drawMode;
    var simpleMesh = new pixi_jsLegacy.SimpleMesh(texture, vertices, uvs, indices, drawMode);
  ...
  var SimpleRope$1 = function SimpleRope(root, props) {
    ...
    var rope = new pixi_jsLegacy.SimpleRope(texture, points);
  ...
  */
  ...
  {module.exports=function $$$reconciler($$$hostConfig){var exports={};var React=React__default['default'];var _assign=objectAssign;var Scheduler=scheduler;var tracing$1=tracing;var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// by calls to these methods by a Babel plugin.
  //
  ...
  workInProgress.flags|=Update;}function markRef$1(workInProgress){workInProgress.flags|=Ref;}var appendAllChildren;var updateHostContainer;var updateHostComponent$1;var updateHostText$1;if(supportsMutation){// Mutation mode
  ...
  disconnect();}};}var didWarnAboutMessageChannel=false;var enqueueTaskImpl=null;function enqueueTask(task){if(enqueueTaskImpl===null){try{// read require off the module object to get around the bundlers.
  ...
  // and cleans up
  return {then:function(resolve,reject){called=true;result.then(function(){if(actingUpdatesScopeDepth>1||isSchedulerMocked===true&&previousIsSomeRendererActing===true){onDone();resolve();return;}// we're about to exit the act() scope,
  ...
  return {then:function(resolve){{error('Do not await the result of calling act(...) with sync logic, it is not a Promise.');}resolve();}};}}function detachFiberAfterEffects(fiber){fiber.sibling=null;fiber.stateNode=null;}var resolveFamily=null;// $FlowFixMe Flow gets confused by a WeakSet feature check below.
  ...
  function render(element, container) {
    ...
    invariant(pixi_jsLegacy.Container.prototype.isPrototypeOf(container), 'Invalid argument `container`, expected instance of `PIXI.Container`.');
  ...
  var Stage = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(Stage, [{
      ...
      value: function componentDidMount() {
        ...
        this.app = new pixi_jsLegacy.Application(_objectSpread2(_objectSpread2({
          width: width,
          height: height,
          view: this._canvas
        }, options), {}, {
        ...
        if (renderOnComponentChange && !raf) {
          this._ticker = new pixi_jsLegacy.Ticker();
  ...
  function useApp() {
    ...
    invariant(app instanceof pixi_jsLegacy.Application, 'No Context found with `%s`. Make sure to wrap component with `%s`', 'PIXI.Application', 'AppProvider');
    return app;
  }
  ...
  var withFilters = function withFilters(WrapperComponent, filters) {
    ...
    var Wrapper = function Wrapper(_ref) {
      var children = _ref.children,
          apply = _ref.apply,
          props = _objectWithoutProperties(_ref, _excluded); // create filters
